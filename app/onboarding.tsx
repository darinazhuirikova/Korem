...
export default function OnboardingScreen() {
  ...
  // Экран 1: логотип и подсказка «коснись, чтобы продолжить»
  ...
  // Экран 2: выбор языка интерфейса
  ...
  // Экран 3: краткое описание и кнопка «Продолжить»
  return (
    <View style={styles.wrapper}>
      <View style={styles.container}>
...
const styles = StyleSheet.create({
  ...
  splashWrapper: {
    flex: 1,
    backgroundColor: '#0E0F24', // фоновый цвет
    alignItems: 'center',
    justifyContent: 'center',
    width: '100%',
    height: '100%',
  ...
  splashLogo: {
    width: 180, // крупнее для лучшей читаемости
    height: 180,
    marginBottom: 48,
  },
  hint: {
