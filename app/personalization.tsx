...
export default function PersonalizationScreen() {
  ...
  // Загружаем статус озвучки при запуске
  useEffect(() => {
  ...
  // Озвучка для каждого шага (если включена)
  useEffect(() => {
  ...
  // Шаг 2: "Хотите выключить озвучку интерфейса?"
  ...
  // --- ЭКРАН: "Какой способ предупреждения..." ---
  if (step === 'warn') {
    return (
